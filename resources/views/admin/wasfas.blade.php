        ...
        <div class="card mg-b-20">
            <div class="card-header pb-0">
                <div class="d-flex justify-content-between">
                    ...
                    <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-scale" data-toggle="modal" href="#modaldemo8">اضافة وصفات</a>
                </div>
            </div>
            <div class="card-body">
                <div class="tile-body">
...
<script>
    $(document).ready(function() {
        ...
        $('body').on('click', '#showEditModelCategory', function() {
            ...
            var nutr_name = $(this).data('name');

            $('#nutr_id').val(nutr_id);
            var nutr_val = $(this).data('value');
            $.get('/admin/wasfa/edit/' + nutr_id, function(data) {
                $('#editmodelNutrl').modal('show');

                $('#nutr_name').val(nutr_name);
